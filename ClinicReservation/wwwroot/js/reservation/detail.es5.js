...
var detail_script = function detail_script(map) {
    "use strict";

    var btn_rat_show = function btn_rat_show(sender, args) {
    ...
    var btn_click = function btn_click(sender, args) {
        var btn = this;
    ...
    var btn_cancel_flyoutshow = function btn_cancel_flyoutshow(sender, args) {
    ...
    var btn_stop_flyoutshow = function btn_stop_flyoutshow(sender, args) {
    ...
    var btn_postmessage_flyoutshow = function btn_postmessage_flyoutshow(sender, args) {
    ...
    var load = function load() {
        ...
        if (btn_stoppost.length > 0) btn_stoppost[0].context.events.add("flyout_showing", btn_stop_flyoutshow);
