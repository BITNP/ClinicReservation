...
(function () {
    ...
    var check_username = function check_username(name) {
        var dtd = $.Deferred();
    ...
    var username_keyup_blur = function username_keyup_blur(e) {
    ...
    var password_keyup_blur = function password_keyup_blur(e) {
